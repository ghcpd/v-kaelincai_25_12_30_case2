...
class Calculator:
    ...
    Version History:
    - v1.0: Initial stable release (8 months of stable operation)
    - v1.1: Added angle mode for trigonometric functions (introduced regression bug)
    """
    ...
    def set_angle_mode(self, use_degrees: bool):
        ...
        Note: This feature was added in v1.1
        """
...
def main():
    ...
    # Test cases that work in v1.0 (angle_mode=False)
    ...
    # Test cases in v1.1 (angle_mode=True) - these will show the bug
    print("\n[Angle Mode - v1.1 behavior with BUG]")
